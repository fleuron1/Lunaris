...
export const SPELLS = [
  ...
  { level: 1,   name: 'Cure Wounds',        castTime: '1 Action',       range: 'Touch',  conc: false, ritual: false, mat: false, lunar: 'full',     notes: 'Lunar bonus | 1d8+4 HP' },
  ...
  { level: 1,   name: 'Chromatic Orb',      castTime: '1 Action',       range: '90 ft',  conc: false, ritual: false, mat: true,  notes: '+6 to hit | 3d8 (choose type) | 50gp diamond' },
  { level: 1,   name: 'Sleep',              castTime: '1 Action',       range: '90 ft',  conc: false, ritual: false, mat: false, notes: '5d8 HP of creatures fall asleep' },
  ...
  { level: 2,   name: 'Moonbeam',           castTime: '1 Action',       range: '120 ft', conc: true,  ritual: false, mat: false, lunar: 'full',     notes: 'Lunar bonus | 2d10 radiant/turn | CON save' },
  { level: 2,   name: 'Invisibility',       castTime: '1 Action',       range: 'Touch',  conc: true,  ritual: false, mat: true,  lunar: 'new',      notes: 'Lunar bonus | 1 hr | eyelash + gum arabic' },
  ...
  { level: 2,   name: 'Scorching Ray',      castTime: '1 Action',       range: '120 ft', conc: false, ritual: false, mat: false, notes: '3 rays | +6 to hit | 2d6 fire each' },
